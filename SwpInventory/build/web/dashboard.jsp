...
<html lang="vi">
    <head>
        ...
        <style>
            /* --- CSS giữ nguyên như bạn đã có, có thể rút gọn ở đây nếu cần --- */
            * {
            ...
            .user-menu label:hover, .user-menu label:focus {
                border-color: #FDF9DA;
                outline: none;
            }
                ...
                <div class="nav">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="product_list.jsp"><i class="fas fa-list"></i> Danh sách sản phẩm</a>
                            <a href="product_add.jsp"><i class="fas fa-plus"></i> Thêm sản phẩm</a>
                            <a href=""><i class="fas fa-list"></i> Sản phẩm tồn kho</a>
