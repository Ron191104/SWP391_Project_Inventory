...
<body>
    <header class="header">
        ...
        <div class="header-right">
            <div class="search-box" role="search">
                <input type="search" placeholder="Tìm ki?m..." aria-label="Tìm ki?m s?n ph?m ho?c nh?p kho..." id="searchInput" />
    ...
    <main class="container">
        <form action="/import" method="post" autocomplete="off">
            <label for="search">Tìm ki?m s?n ph?m</label>
            <div class="search-box">
                <input type="search" id="search" placeholder="Tìm ki?m s?n ph?m..." aria-label="Tìm ki?m s?n ph?m" />
            </div>
        ...
        <form action="/add_product" method="post" autocomplete="off">
            <label for="new_product_code">Mã SP</label>
            <input type="text" id="new_product_code" name="product_code" required />

            <label for="new_product_name">Tên s?n ph?m</label>
