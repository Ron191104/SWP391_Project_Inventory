...
<head>
    ...
    <title>Th?ng kê kho - Qu?n lý kho</title>
    <style>
        /* Reset and base */
        * {
...
<body>
    <div class="header">
        <div class="header-left">
            ...
            <div class="nav">
                ...
                <a href="stats.html" class="active">Th?ng kê</a>
                <a href="login.html">??ng xu?t</a>
            </div>
        </div>
        <div class="header-right">
            <div class="search-box" role="search">
                <input type="search" placeholder="Tìm ki?m..." aria-label="Tìm ki?m s?n ph?m" />
    ...
    <div class="container">
        <div class="stats-box">
            <div>
                <h2>T?ng s? s?n ph?m</h2>
                <div style="font-size:2rem; color:#2980b9;">2</div>
            </div>
            <div>
                <h2>T?ng s? l??ng nh?p</h2>
                <div style="font-size:2rem; color:#27ae60;">100</div>
            </div>
            <div>
                <h2>T?ng s? l??ng xu?t</h2>
                <div style="font-size:2rem; color:#e67e22;">55</div>
            </div>
        </div>
        <h2>T?n kho hi?n t?i</h2>
        <table>
            <thead>
                <tr>
                    <th>Mã SP</th>
                    <th>Tên s?n ph?m</th>
                    <th>S? l??ng còn l?i</th>
                </tr>
            </thead>
            <tbody>
                <tr>
