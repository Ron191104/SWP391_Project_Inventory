...
public class EmailSender {
    ...
    public void sendEmail(String receiverEmail, String otp) throws MessagingException {
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("jungyyy123@gmail.com", "viuyacehowcavlds");
            }
        });

        Message message = new MimeMessage(session);
        message.setFrom(new InternetAddress("jungyyy123@gmail.com"));
    ...
    public static void main(String[] args) {
        ...
        try {
            es.sendEmail("jungyyy123@gmail.com", "123456");
        } catch (Exception e) {
        }
