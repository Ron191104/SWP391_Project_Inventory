...
public class StoreInventoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<StoreProduct> listProduct = dao.getProductsByStoreId(storeId);
            System.out.println("Servlet StoreInventoryController đã chạy!");
System.out.println("storeId: " + storeId);
System.out.println("Số sản phẩm: " + listProduct.size());
