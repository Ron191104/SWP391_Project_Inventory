...
public class ProcessCheckoutController extends HttpServlet {
 ...
 HttpSession session = request.getSession();
        ...
        boolean usePoints = request.getParameter("usePoint") != null; 
        ...
        if (usePoints && customerId > 0 && customerPoints > 0) {
            double discount = customerPoints * salesDAO.getAmountPerPoint();
            totalAmount = Math.max(0, totalAmount - discount);
            customerDAO.subtractPoints(customerId, customerPoints);
        }
